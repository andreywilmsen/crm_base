...
@section('content_header')
    <div class="d-flex align-items-center">
        <a href="{{ route('record-status.index') }}" class="btn btn-default btn-sm border shadow-sm mr-3">
            <i class="fas fa-arrow-left text-muted"></i>
        </a>
        <h1 class="m-0 text-dark">{{ isset($status) ? 'Editar Status' : 'Novo Status' }}</h1>
    </div>
@stop
            ...
            <div class="card-header bg-white py-3 border-bottom">
                ...
                <div class="card-tools">
                    <span class="badge badge-light border text-secondary px-2 py-1">
                        ID: {{ isset($status) ? $status->getId() : 'Novo' }}
                    </span>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-0">
                                <label for="name" class="text-uppercase font-weight-bold">Nome do Status</label>
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name', isset($status) ? $status->getName() : '') }}"
